<html>
    ...
    <body>
        <?php
            ...
            echo "<br><br>Arredondamento de $n2 é igual a: " .round($n2);
            echo "<br><br>O arredondamento para cima de $n2 é igual a: " .ceil($n2);
            echo "<br><br> O arredondamento para baixo de $n2 é igual a: " .floor($n2);

            echo"<br><br><br>";
            echo"A parte inteira de $n2 e igual a " .intval($n2);
            echo"<br><br>";
